...
MoveEntry::MoveEntry(const sf::Vector2f& initialPos, float initialSize, sf::Texture* buttonTexture)
...
void MoveEntry::setData(sf::Texture* texture, const std::string& movename, const std::string& eval)
{
