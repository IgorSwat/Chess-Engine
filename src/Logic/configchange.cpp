...
CheckerChange::CheckerChange(Piece** wCheckers, Piece** bCheckers, std::vector<sf::Vector2i>** savers)
{
    this->whiteCheckers = new Piece* [2];
    this->blackCheckers = new Piece* [2];
    this->checkSavers = new std::vector<sf::Vector2i>* [2];
...
{
    sf::Vector2i pos = config->getPiece(pieceID)->getPos();
