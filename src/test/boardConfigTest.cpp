...
namespace Testing {
    ...
    void staticLoadingTest()
	{
		...
		assert(board.pinningPieces(WHITE) == 0x0000000200001000);
		...
		assert(board2.pinningPieces(WHITE) == 0x0000000200001000);
	...
	void pinsAndChecksTest()
	{
		...
		assert(board.pinningPieces(WHITE) == square_to_bb(SQ_B5));
