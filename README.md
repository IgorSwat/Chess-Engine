...
+ Basic search&nbsp; <img src="md/delete.png" alt="Delete icon" width="20" height="20">
...
---
+ Neural network model (NNUE) implementation and training&nbsp; <img src="md/delete.png" alt="Delete icon" width="20" height="20">
+ Neural network connection with evaluation function&nbsp; <img src="md/delete.png" alt="Delete icon" width="20" height="20"><br><br>
